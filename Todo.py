from tkinter import Button, Entry, Menu, Scrollbar, Tk, Frame, Listbox
from tkinter.constants import ANCHOR, END, RIGHT, LEFT, BOTH
...
################### ADD item entry box#################
my_entry = Entry(root, font=("Helvetica", 24), width=24, background="#9e9e9e")
...
cross_off_button = Button(
    button_frame, text="Cross Item", command=cross_off_item)
uncross_button = Button(
    button_frame, text="Uncross Item", command=uncross_item)
delete_crossed_button = Button(
    button_frame, text="Delete Cross Item", command=delete_crossed)
